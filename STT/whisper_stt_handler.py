...
class WhisperSTTHandler(BaseHandler):
    ...
    def setup(
        ...
        language="ja",
        gen_kwargs={},
        stt_broadcast_queue=None,  # <--- added
    ):
        self.device = device
        ...
        self.warmup()
        self.stt_broadcast_queue = stt_broadcast_queue
    ...
    def process(self, spoken_prompt):
        ...
        if self.stt_broadcast_queue is not None:
            self.stt_broadcast_queue.put(("user", pred_text))
